...
from risk_models.claus.claus3 import calculate_risk, get_lifetime_risk
...
class ClausTest(TestCase):
    ...
    def test_one_1st_deg(self):
        ...
        score = calculate_risk(20, full_sister_onset_ages=[
                               32], maternal_grandmother_onset_ages=[55])
    ...
    def test_one_2nd_deg(self):
        ...
        score = calculate_risk(20, maternal_grandmother_onset_ages=[
                               67], paternal_half_sister_onset_ages=[12])
    ...
    def test_two_1st_deg(self):
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_FIRST_DEG_TABLE, 20, 0, 2))
    ...
    def test_two_sec_deg_diff_side(self):
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_DIFF_SIDE_TABLE, 20, 2, 5))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_DIFF_SIDE_TABLE, 20, 2, 3))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_DIFF_SIDE_TABLE, 20, 3, 4))
    ...
    def test_two_sec_deg_same_side(self):
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_SAME_SIDE_TABLE, 20, 3, 5))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_SAME_SIDE_TABLE, 20, 2, 3))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_SAME_SIDE_TABLE, 20, 0, 3))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_SAME_SIDE_TABLE, 20, 0, 2))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_SAME_SIDE_TABLE, 20, 1, 2))
        ...
        self.assertEqual(score, get_lifetime_risk(
            TWO_SEC_DEG_SAME_SIDE_TABLE, 20, 0, 5))
    ...
    def test_get_lifetime_risk_one_relative(self):
        ...
        expected_score = (table[5][3] - current_age_risk) / \
            (1 - current_age_risk)
    ...
    def test_get_lifetime_risk_on_two_relatives(self):
        ...
        current_age_risk = table[1][4][1] + \
            (table[2][4][1] - table[1][4][1]) * 8 / 10
        expected_score = (
            table[5][4][1] - current_age_risk) / (1 - current_age_risk)
        self.assertEqual(computed_score, round(expected_score, 3))
